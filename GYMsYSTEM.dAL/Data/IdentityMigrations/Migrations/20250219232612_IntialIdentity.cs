...
namespace GYMsYSTEM.dAL.Data.IdentityMigrations.Migrations
{
    /// <inheritdoc />
    public partial class IntialIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MealsCategory", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Meal_MealsCategory_MealsCategoryId",
                        column: x => x.MealsCategoryId,
                        principalTable: "MealsCategory",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Meal_NutritionPlan_NutritionPlanId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_NutritionPlan_NutritionPlanId",
                        column: x => x.NutritionPlanId,
                        principalTable: "NutritionPlan",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Session_AspNetUsers_TrainerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Membership_SubscriptionPlan_SubscriptionPlanId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Meal_MealsCategoryId",
                table: "Meal",
                column: "MealsCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Meal_NutritionPlanId",
                table: "Meal",
                column: "NutritionPlanId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Membership_SubscriptionPlanId",
                table: "Membership",
